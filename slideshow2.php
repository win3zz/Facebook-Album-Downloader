...
<head>
	...
	*{outline:none;}
	...
	#toolbar{position:fixed; z-index:3; right:10px; top:10px; padding:5px; background:url(libs/slideshow_helper/fs_img_g_bg.png);}
	#toolbar img{border:none;}
	#img_title{position:fixed; z-index:3; left:10px; top:10px; padding:10px; background:url(libs/slideshow_helper/fs_img_g_bg.png); color:#FFF; font-family:'Josefin Sans Std Light', arial, serif; font-size:24px; text-transform:uppercase;}
	...
	#thumbnails_wrapper{z-index:2; position:fixed; bottom:0; width:100%; background:url(libs/slideshow_helper/empty.gif); /* stupid ie needs a background value to understand hover area */}
	#outer_container{position:relative; padding:0; width:100%; margin:40px auto;}
	#outer_container .thumbScroller{position:relative; overflow:hidden; background:url(libs/slideshow_helper/fs_img_g_bg.png);}
	...
	.nextImageBtn{right:0; background:#000 url(libs/slideshow_helper/nextImgBtn.png) center center no-repeat;}
	.prevImageBtn{background:#000 url(libs/slideshow_helper/prevImgBtn.png) center center no-repeat;}
	.button {
		width: auto;
		border: 0 !important;
	...
	<script type="text/javascript" src="libs/slideshow_helper/jquery.easing.1.3.js"></script>
</head>
<body>
	...
	<div id="bg">
		...
		<img src="" width="1680" height="1050" id="bgimg" />  
	</div>
	<div id="preloader"><img src="libs/slideshow_helper/ajax-loader_dark.gif" width="32" height="32" /></div>
	<div id="img_title"></div>
	<div id="toolbar"><a href="#" title="Maximize" onClick="ImageViewMode('full');return false"><img src="libs/slideshow_helper/toolbar_fs_icon.png" width="50" height="50"  /></a></div>
						...
						foreach ($photos as $photo){
							...
							if ($isFirstLoad)
							{
								?>
									<script>
										$(function(){
											$("#bgimg").attr("src","<?php echo $photo['source']; ?>");
										});
									</script>
								<?php
								$isFirstLoad = False;
	...
	$(window).load(function() {
		...
		if($defaultViewMode=="full"){
			$toolbar_a.html("<img src='libs/slideshow_helper/toolbar_n_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('normal');return false").attr("title", "Restore");
		} else {
			$toolbar_a.html("<img src='libs/slideshow_helper/toolbar_fs_icon.png' width='50' height='50'  />").attr("onClick", "ImageViewMode('full');return false").attr("title", "Maximize");
		}
